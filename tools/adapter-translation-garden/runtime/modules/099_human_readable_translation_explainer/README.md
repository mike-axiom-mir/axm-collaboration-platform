...
**ID:** `axm.adapter.human-readable-translation-explainer`  
...
Explain what was translated, why a route was chosen, what changed or was lost, and the safest next action.
