# 068 — Emulator and VM Launch Descriptor

**ID:** `axm.adapter.emulator-vm-launch-descriptor`  
**Status:** `SHADOW_ONLY`  
...
Describe a confined emulated machine, guest OS, devices, images, snapshots, and allowed host bridges for legacy execution.
