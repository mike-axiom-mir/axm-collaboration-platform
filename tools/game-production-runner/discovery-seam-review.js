...
ok(manifest.produces.includes(Core.cacheReferences.SCHEMA) && manifest.actions.includes('discover cache references from sealed terminal ledgers read-only'), 'tool manifest declares bounded terminal-ledger reference discovery');
...
ok(contract.boundaries.refuses.includes('cache-reference-authority-from-incomplete-run') && contract.boundaries.refuses.includes('cache-reference-authority-from-tampered-or-mixed-ledger') && contract.boundaries.refuses.includes('cache-reference-key-entry-digest-contradiction'), 'reference discovery and exact-entry contradiction boundaries are explicit');
