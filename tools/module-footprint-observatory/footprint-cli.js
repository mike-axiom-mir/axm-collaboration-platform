...
function main() {
  ...
  if (args.help) {
    process.stdout.write([
      ...
      '',
      'Usage:',
      '  node footprint-cli.js --root /path/to/workshop',
      '  node footprint-cli.js --root /path/to/workshop --output footprint.json --quiet',
      '  node footprint-cli.js --root /path/to/workshop --browser-output footprint.js --quiet',
      '',
...
try {
  ...
  process.stderr.write('Module footprint scan refused: ' + (error && error.message || error) + '\n');
  process.exitCode = 1;
}
