...
const shell=read('ai-team.js'),html=read('index.html'),core=read('ai-team-core.js'),hub=read('../../hub/hub-shell.js'),presence=read('../../hub/ai-presence.js');
...
const checks=[
  ...
  ['Ten beginner-facing views cover control, work, build, evaluation and learning',/id:'overview'/.test(core)&&/id:'services'/.test(core)&&/id:'forge'/.test(core)&&/id:'data'/.test(core)],
