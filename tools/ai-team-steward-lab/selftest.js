...
const gapReport = JSON.parse(fs.readFileSync(path.join(ROOT, 'intakes', 'ai-team-collaboration-runs-01-101-v1', 'CAPABILITY_GAP_REPORT.json'), 'utf8'));
const capabilityRequirements = JSON.parse(fs.readFileSync(path.join(ROOT, 'intakes', 'ai-team-collaboration-runs-01-101-v1', 'CAPABILITY_REQUIREMENTS.json'), 'utf8'));
const capabilityInventory = JSON.parse(fs.readFileSync(path.join(ROOT, 'intakes', 'ai-team-collaboration-runs-01-101-v1', 'CAPABILITY_INVENTORY.json'), 'utf8'));
