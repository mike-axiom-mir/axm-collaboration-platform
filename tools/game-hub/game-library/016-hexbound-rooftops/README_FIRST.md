...
- claim-anchor base building with four shared macro roles, eight faction roofline treatments, four district charters, mixed-charter wonderweb bonuses, Boo's Spectral Census fog conversion, Moonwake's Black-Sail route conversion, Thorn Court's Briarway repair conversion, and no routine siege units;
