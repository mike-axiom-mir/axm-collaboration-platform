...
const RELEASE_VERSION = '0.19.0-last-rites-exchange';
const RELEASE_FEATURES = { factionDistrictConversions:7, everyWindowAssemblyCivicCover:true, everyWindowAssemblyPeriodSeconds:13, everyWindowAssemblyDurationSeconds:5, everyWindowAssemblyRange:520, everyWindowAssemblyDamageReduction:.14, everyWindowAssemblyMixedCharterScaling:true, everyWindowAssemblyEffectsStack:false, everyWindowAssemblyProtectsBuildings:false, everyWindowAssemblyBenefitsAiAllies:true, lastRitesExchangeWakeDividend:true, lastRitesExchangeRange:520, lastRitesExchangeEssenceBonus:.55, lastRitesExchangeMixedCharterScaling:true, lastRitesExchangeEffectsStack:false, lastRitesExchangeTargetsBuildings:false, lastRitesExchangeRivalParity:true, rivalSpendsWakeDividends:true };
