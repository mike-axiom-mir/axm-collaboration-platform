...
function loadCurrentSources(options = {}) {
  ...
  const adapterId = (status.foundationDevelopmentCapabilityOutputAdapterPlannerEvidence || {}).currentBatchId;
  const handId = (status.foundationDevelopmentHandPlannerEvidence || {}).currentBatchId;
