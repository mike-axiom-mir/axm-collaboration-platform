...
const receipt = {
  ...
  reachedProductChecks:{
    ...
    stageArchival:output.includes('publication stage archival selftest: PASS (183 assertions'),
...
const expectedForeignFailure = receipt.exitCode === 1 && Object.values(receipt.reachedProductChecks).every(Boolean) && receipt.failure.exactMessagePresent &&
