# Integration handoff — bounded record query specialist v2.18
...
- Target review: PR67
- Immediately before technical publication, the remote target and PR67 head
  both equalled the required stacked target exactly. PR67 was open, draft, and
  clean/mergeable.
...
PR68 is intentionally stacked on PR67. Review or acceptance of PR68 must not
skip the still-separate decision for PR67. The preferred integration action is
review in PR68 after confirming its displayed head equals the sealed tip
...
docs/steward-runs/2026-08-25-code-capability-fabric-bounded-record-query-v2.18/CAPABILITY_GAP_AFTER.json
docs/steward-runs/2026-08-25-code-capability-fabric-bounded-record-query-v2.18/CAPABILITY_GAP_BEFORE.json
docs/steward-runs/2026-08-25-code-capability-fabric-bounded-record-query-v2.18/CAPABILITY_INVENTORY_AFTER.json
docs/steward-runs/2026-08-25-code-capability-fabric-bounded-record-query-v2.18/CAPABILITY_INVENTORY_BEFORE.json
docs/steward-runs/2026-08-25-code-capability-fabric-bounded-record-query-v2.18/CAPABILITY_REQUIREMENTS.json
docs/steward-runs/2026-08-25-code-capability-fabric-bounded-record-query-v2.18/EVIDENCE_ROUTE.md
...
```powershell
$expectedTarget = '1e0a81d94d658a96e0889529af66ebeb38e0e95c'
$expectedTechnical = '092a201aef235e60d0c2ec36621fe003cde6fa3b'
$targetRef = 'refs/remotes/origin/codex/code-capability-fabric-closed-object-adapter-v2.17'
$sourceRef = 'refs/remotes/origin/codex/code-capability-fabric-bounded-record-query-v2.18'

git fetch origin `
  codex/code-capability-fabric-closed-object-adapter-v2.17:$targetRef `
  codex/code-capability-fabric-bounded-record-query-v2.18:$sourceRef
...
The preferred action is review PR68 and use GitHub's displayed immutable commit
identity for its sealed head. Only after Mike accepts PR67 and explicitly
chooses a clean integration target whose `HEAD` is exactly `$expectedTarget`
may that target be fast-forwarded to the reviewed PR68 head:
...
run the merge. Before any use, compare `$reviewedSealedTip` with the exact PR68
