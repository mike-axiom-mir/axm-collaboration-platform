...
for (const phase of ['BEFORE', 'AFTER']) {
  const result = childProcess.spawnSync('python', [comparator, '--requirements', path.join(dir, 'CAPABILITY_REQUIREMENTS.json'), '--capabilities', path.join(dir, 'CAPABILITY_INVENTORY_' + phase + '.json')], {
