...
const receipt = {
  ...
  sessionId: 'model-shadow-review-challenge-transition-local-possession-checkpoint-anchor:2026-08-20',
  status: 'TEST',
  ...
  temporaryMaterialDeleted: {
    count: 9,
    reason: 'Three v1.6 roots, two v1.5 roots, two v0.5 anchor roots and two v1.4 roots across focused, immediate-lineage and full-verification invocations were removed by verified selftest cleanup. No user source, raw command log, screenshot, recording, external anchor/witness/checkpoint, identity attestation or incoming specialist ZIP was retained.'
  },
