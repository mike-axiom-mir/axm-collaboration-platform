...
const EVIDENCE_COMMIT = '27dc1812b8c96e71b089a184d46e22bb21aa51c2';
const EVIDENCE_TREE = '03fc925c3be6ea76877020730ec2b1c6920b6eda';
const EVIDENCE_PATH = 'docs/steward-runs/2026-08-21-review-inbox-operation-lease-retirement';
...
const container = fs.mkdtempSync(path.join(path.parse(ROOT).root, 'e44-'));
