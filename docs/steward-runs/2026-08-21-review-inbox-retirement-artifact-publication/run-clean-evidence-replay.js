...
const EVIDENCE_COMMIT = '93cef72775400640b613db3ac047871c669f2d01';
const EVIDENCE_TREE = 'c7f45b3a35b6578dd90a96881800ca10d315d07d';
const EVIDENCE_PATH = 'docs/steward-runs/2026-08-21-review-inbox-retirement-artifact-publication';
...
const temp = fs.mkdtempSync(path.join(os.tmpdir(),'axm-v50-clean-evidence-')), archive = path.join(temp,'evidence.tar');
try {
