...
const receipt = {
  ...
  sessionId: 'model-shadow-review-challenge-separation-gate:2026-08-20',
  status: 'TEST',
  ...
  temporaryMaterialDeleted: {
    count: 0,
    reason: 'Focused tests own and remove synthetic ledger roots, separated packages and generated private keys. No screenshot, recording, raw log, private-key file, live signature file, identity attestation, or human review artifact was retained.'
  },
