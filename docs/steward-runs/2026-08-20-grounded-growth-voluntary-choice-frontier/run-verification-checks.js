...
const FOCUSED = [
  ...
  'node docs/steward-runs/2026-08-20-grounded-growth-voluntary-choice-frontier/selftest.js',
  'node docs/steward-runs/2026-08-20-grounded-growth-voluntary-choice-frontier/build-current-voluntary-choice-frontier.js',
  ...
  'node docs/steward-runs/2026-08-20-grounded-growth-human-route-coverage/verification-selftest.js',
...
function build() {
  ...
  const receipt = {
    schema: 'axm.grounded-growth-voluntary-choice-frontier-check-results/v1',
    version: '0.1.0',
    status: 'TEST',
  ...
  receipt.resultsDigest = Choice.sha256(payload);
  return receipt;
}
