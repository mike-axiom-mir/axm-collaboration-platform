...
function fileRef(relativePath) {
  return {
    path: relativePath,
    sha256: sha256(fs.readFileSync(path.join(workshop, relativePath)))
  };
}

const current = readJson('docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CURRENT_EVIDENCE_FRONTIER_RECEIPT.json');
const gapBefore = readJson('docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_GAP_BEFORE.json');
const gapAfter = readJson('docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_GAP_AFTER.json');
...
const sourcePaths = [
  ...
  'shared/grounded-growth-frontier-gate/grounded-growth-evidence-frontier-receipt.schema.json',
  ...
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/build-current-evidence-frontier.js',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/build-verification-receipt.js',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/selftest.js',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/README.md',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/EVIDENCE_ROUTES.md',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_REQUIREMENTS.json',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_INVENTORY_BEFORE.json',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_INVENTORY_AFTER.json',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_GAP_BEFORE.json',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CAPABILITY_GAP_AFTER.json',
  'docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/CURRENT_EVIDENCE_FRONTIER_RECEIPT.json'
];

const receipt = {
  schema: 'axm.grounded-growth-evidence-frontier-verification-receipt/v1',
  version: '0.1.0',
  generatedAt: '2026-08-19T16:19:00.000Z',
  status: 'TEST',
  result: 'PASS_WITH_DECLARED_LIMITS',
  focused: {
    explicitAssertions: 82,
    commands: [
      { command: 'node shared/grounded-growth-frontier-gate/selftest.js', verdict: 'PASS', assertions: 56 },
      { command: 'node docs/steward-runs/2026-08-19-grounded-growth-evidence-frontier/selftest.js', verdict: 'PASS', assertions: 26 }
    ]
  },
  adjacent: {
    explicitAssertions: 223,
    commands: [
  ...
  browserVerification: {
    verdict: 'NOT_RUN',
    reason: 'No UI, browser, controller runtime, or visual surface changed in this increment.'
  },
  currentState: {
    receiptSchema: current.schema,
    receiptDigest: current.evidenceFrontierDigest,
    portfolioCapabilityChains: current.counts.portfolioCapabilityChains,
    supplementalPhoneEvidenceRoutes: current.counts.supplementalPhoneEvidenceRoutes,
  ...
  sharedWorkspace: {
    ...
    knownActiveForeignSeams: [
      'AXM_AETHERGLASS_VISUAL_ENGINE_v7_1_0/MODULE_MANIFEST.json',
      'AXM_AETHERGLASS_VISUAL_ENGINE_v7_1_0/docs/VISUAL_CONTRACTS.md',
      'AXM_AETHERGLASS_VISUAL_ENGINE_v7_1_0/src/axm-visual-contract.js'
    ],
    scanTruncated: true
  },
...
console.log('PASS Grounded Growth evidence-frontier verification receipt built');
...
console.log('broad=' + receipt.broadVerification.verdict + ' failures=' + receipt.broadVerification.failures + ' warningGroups=' + receipt.broadVerification.warningGroups);
