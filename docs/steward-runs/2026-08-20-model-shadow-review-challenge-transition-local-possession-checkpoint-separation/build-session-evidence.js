...
const receipt = {
  ...
  sessionId: 'model-shadow-review-challenge-transition-local-possession-checkpoint-separation:2026-08-20',
  status: 'TEST',
  ...
  temporaryMaterialDeleted: {
    count: 11,
    reason: 'Three v1.7 roots, two v1.6 roots, two v0.6 separation roots, two v1.5 roots and two v1.4 roots across focused, immediate-lineage and full-verification invocations were removed by verified selftest cleanup. No user source, raw command log, screenshot, recording, external anchor/separation/checkpoint, identity attestation or incoming specialist ZIP was retained.'
  },
