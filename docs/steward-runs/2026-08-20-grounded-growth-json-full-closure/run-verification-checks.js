...
const FOCUSED = [
  ...
  'node docs/steward-runs/2026-08-20-grounded-growth-json-full-closure/capture-v03-before-state.js',
  ...
  'node docs/steward-runs/2026-08-20-grounded-growth-json-full-closure/run-known-source-evolution-checks.js',
...
function build() {
  ...
  const receipt = {
    schema: 'axm.grounded-growth-json-full-closure-check-results/v1',
    version: '0.1.0',
    status: 'TEST',
    ...
    summary: {
      ...
      knownExpectedStaleSourceChecks: 11
    },
    retention: {
    ...
    limits: {
      ...
      workshopWideSerializationAuditRun: false,
