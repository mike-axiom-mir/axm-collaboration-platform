...
const EVIDENCE_COMMIT = 'd7deff9d5ae3eb7d5cd34f76390d0c9b6312c4a2';
const EVIDENCE_TREE = '7bb0623199fc51947ae9bbecb10b648c1805bbb2';
const EVIDENCE_PATH = 'docs/steward-runs/2026-08-21-review-inbox-retirement-stage-archival-intent-privacy';
const slicePaths = [
  EVIDENCE_PATH,
  'tools/deterministic-json-core',
  'shared/operations/review-operation-lease-retirement-publication-archival-intent-v2.schema.json',
  'shared/operations/review-operation-lease-retirement-publication-archival-authorization-status-v2.schema.json',
  'shared/operations/review-operation-lease-retirement-publication-archival-result-v3.schema.json'
];
...
const temp = fs.mkdtempSync(path.join(os.tmpdir(),'axm-v53-clean-evidence-')), archive = path.join(temp,'evidence.tar');
try {
