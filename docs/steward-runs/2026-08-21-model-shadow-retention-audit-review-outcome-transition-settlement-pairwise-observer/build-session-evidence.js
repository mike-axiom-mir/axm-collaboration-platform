...
const openEvidence = [
  'complete proposal and settlement history comparison',
  ...
  'actual external retention or independent custody of roots and caller packages',
  'atomic two-root observation or later currentness',
  'protected monotonic storage deletion or rollback prevention',
  'withheld frontier exclusion global uniqueness or globally consistent log',
...
const receipt = {
  ...
  sessionId: '2026-08-21-model-shadow-retention-audit-review-outcome-transition-settlement-pairwise-observer-v3.8',
