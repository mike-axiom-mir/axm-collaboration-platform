...
const prior = JSON.parse(fs.readFileSync(path.join(ROOT, 'docs/steward-runs/2026-08-21-model-shadow-retention-audit-review-outcome-history-checkpoint/CHECK_RESULTS.json'), 'utf8'));
const FOCUSED = [
