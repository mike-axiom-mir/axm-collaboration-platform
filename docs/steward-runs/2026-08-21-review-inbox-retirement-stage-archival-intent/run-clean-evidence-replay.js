...
const EVIDENCE_COMMIT = '2403673c41bea053a2ee45801d2926cfdbf043f6';
const EVIDENCE_TREE = '188df66f77ee1957558431edbab1ef1d3a266706';
const EVIDENCE_PATH = 'docs/steward-runs/2026-08-21-review-inbox-retirement-stage-archival-intent';
...
const temp = fs.mkdtempSync(path.join(os.tmpdir(),'axm-v52-clean-evidence-')), archive = path.join(temp,'evidence.tar');
try {
