...
const receipt = {
  ...
  sessionId: 'model-shadow-review-challenge-transition-declared-disclosure:2026-08-20',
  status: 'TEST',
  ...
  temporaryMaterialDeleted: {
    count: 0,
    reason: 'Focused tests own and remove synthetic challenge roots, generated private keys, and serialized assessment packages. No raw caller package, screenshot, recording, raw log, private-key file, external receiver receipt, identity attestation, human review artifact, or incoming specialist ZIP was retained.'
  },
