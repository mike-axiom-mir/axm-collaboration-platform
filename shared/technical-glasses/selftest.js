...
const first = Glasses.compile({ root, tools: [tool], readiness: { storage: { state: 'READY', detail: 'local' } }, focus: 'test alpha', focusRoutes: [{ id: 'alpha', destinationId: 'alpha', destinationName: 'Alpha', route: '/tools/alpha/index.html', score: 9 }] , now: '2026-07-18T01:00:00.000Z' });
...
console.log('Technical Glasses selftest: PASS (17 assertions, live fingerprint, retained-evidence view, no-guess priorities, atomic snapshot)');
