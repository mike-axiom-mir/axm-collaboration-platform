...
const checks = [
  ...
  ['Casino alpha is honestly labeled TEST/WORKING and still requires browser/phone QA', () => lux.status === 'TEST-WORKING' && lux.version === '0.3.3-alpha' && lux.max_players === 8 && lux.allowed_seat_types.join(',') === 'human,adapter,ai' && /browser-and-physical-phone-qa-required/.test(lux.package.source_status)],
