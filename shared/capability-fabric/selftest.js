...
function main(){
  ...
  check(BuilderRegistry.activeIds().length===6&&BuilderRegistry.reviewCandidateIds().length===0,'modular builder registry contains six reviewed active builders and no pending candidates');
