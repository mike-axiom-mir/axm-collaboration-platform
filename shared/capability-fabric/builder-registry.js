(function (root, factory) {
  ...
  function objectAdapterContributionSource() {
    ...
    const functions=[stable,byteLength,exactKeys,exact,contractId,adapterFieldName,primitiveValueValid,inspectAdapterPattern,inspectAdapterPrimitive,inspectAdapterObjectSchema,primitiveSchemaCompatible,adapterExample,inspectAdapterParameters,objectAdapterSource,objectAdapterSelftest,buildObjectAdapter].map(function(fn){return String(fn).replace(/\r\n/g,'\n');}).join('\n');
