(function (root, factory) {
  ...
  var providers = node
    ? [
        ...
        require("./hands/pixel-asset-workshop"),
        require("./hands/pixel-animation-workshop"),
        require("./hands/deterministic-animation-fabric"),
        require("./hands/deterministic-audio-fabric"),
        require("./hands/choice-first-visual-simulation"),
        require("./hands/game-visual-pack-selection"),
        require("./hands/pixel-3d-representation"),
        require("./hands/visual-treatment-composer"),
        require("./hands/pbr-material-bake"),
