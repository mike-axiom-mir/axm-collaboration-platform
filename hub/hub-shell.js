...
(function (root, factory) {
  ...
  function workflowLayout(modules, existingLayers) {
    ...
    const groups = {
      ...
      build: ['agent-tool-forge','browser-lan-hardware-qa-lab','cognitive-resource-meter','deterministic-organ-fabric','diagnostics-operations-center','evidence-desk','evolution-foundry','finance-world-room','forge','forge-line','graft','knowledge-canvas','learning-lab','living-world-state-server','module-contract-workbench','module-installer','novelty-diversity-engine','project-room','sandbox','source-connector-hub','workshop-search-provenance'],
